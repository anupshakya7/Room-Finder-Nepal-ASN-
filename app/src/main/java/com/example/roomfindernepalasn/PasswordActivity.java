    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String customerEmail=passwordEmail.getText().toString().trim();
                    ...
                    firebaseAuth.sendPasswordResetEmail(customerEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(PasswordActivity.this,"Erroe in sending password reset email",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
